  ...
  return (
    <div className='p-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-6'>
        ...
        <SummaryCard icon={<FaMoneyBillWave/>} text=" Monthly Salary" number={4} color="bg-red-600"/>
      </div>
  <div className='mt-12'>
    <h4 className='text-center text-2xl font-bold'>Leave Details</h4>
      ...
      <SummaryCard icon={<FaHourglassHalf/>} text=" Leave pending" number={2} color="bg-yellow-400"/>
